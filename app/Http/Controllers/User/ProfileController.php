...
class ProfileController extends Controller
{
    ...
    public function submitProfile(Request $request)
    {
        ...
        $user->save();
        $notify[] = ['success', 'Bravo. Le profil a été mise à jour avec succès'];
    ...
    public function experienceStore(Request $request)
    {
        ...
        $experience->save();
        $notify[] = ['success', 'L\'experience a été ajouté avec succès'];
    ...
    public function experienceUpdate(Request $request, $id)
    {
        ...
        $experience->responsibility = $request->responsibility;
        $experience->save();
        $notify[] = ['success', 'L\'experience a été mis a jour avec succès'];
        return redirect()->back()->withNotify($notify);
    }
    ...
    public function experienceDelete($id)
    {
        try {
            $experience = Experience::findOrFail($id);
            $experience->delete();
            $notify[] = ['success', 'Experience supprimé avec succès'];
            return redirect()->back()->withNotify($notify);
        } catch (\Exception $exp) {
