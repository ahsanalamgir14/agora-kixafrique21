                ...
                <form id="report_form">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">@lang('Rapport')</h5>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="report_sent btn btn-success">@lang('Envoyer')</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        function infinteLoadMore(page) {
            $.ajax({
                ...
                .done(function(response) {
                    if (response.html == '') {
                        $('.auto-load').html("<h5>Aucune donnée disponible.</h5>");
                        return;
                    }
