                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-10 col-lg-12 pt-60">
                                <div class="edit-post global-card">
                                    <h3 class="title mb-4" >@lang('Modifier le message')</h3>
                                    <form method="POST" action="{{ route('user.post.update', $post->id) }}"
                                            ...
                                            <div class="col-sm-12 mb-4">
                                                <div class="form-group">
                                                    <input class="form--control" placeholder="" name="title"
                                                        value="{{ $post->title }}">
                                                    <label class="form--label">@lang('Titre')</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <button class="btn btn--base w-50" style="text-transform: none;">@lang('Mise à jour')</button>
                                    </form>
                                </div>
                            </div>
                        </div>
