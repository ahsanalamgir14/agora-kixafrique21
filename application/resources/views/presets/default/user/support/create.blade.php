                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="row  pt-80 justify-content-center gy-4">
                            ...
                            <form action="{{ route('ticket.store') }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-group">
                                            <select name="priority" class="form-select form--control" required>
                                                ...
                                                <option value="3">@lang('Haut')</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="text-end mt-2">
                                        <button type="button" class="btn btn--base btn-sm addFile">
                                            <i class="fa fa-plus"></i> @lang('Ajouter un nouveau')
                                        </button>
                                    </div>
                                ...
                                <div class="form-group">
                                    <button class="btn btn--base w-100" type="submit" id="recaptcha">&nbsp;@lang('Envoyer')</button>
                                </div>
                            </form>
                        </div>
                    </div>
