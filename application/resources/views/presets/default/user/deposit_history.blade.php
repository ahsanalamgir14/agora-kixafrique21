                                            ...
                                            <form>
                                                <div class="search-box w-100">
                                                    <input type="text" name="search" class="form--control"
                                                        value="{{ request()->search }}" placeholder="@lang('Recherche...')">
                                        ...
                                        <table class="table table--responsive--xl">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">@lang('Crédit')</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn--sm" data-bs-dismiss="modal">@lang('Fermer')</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        (function($) {
            ...
            $('.detailBtn').on('click', function() {
                ...
                if ($(this).data('admin_feedback') != undefined) {
                    var adminFeedback = `
                        <div class="my-3">
                            <strong>@lang('Commentaires de l\'administrateur')</strong>
