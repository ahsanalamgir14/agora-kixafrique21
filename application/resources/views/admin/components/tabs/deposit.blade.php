        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.deposit.list') ? 'active' : '' }}"
                    href="{{route('admin.deposit.list')}}">@lang('Tout')
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.deposit.approved') ? 'active' : '' }}"
                    href="{{route('admin.deposit.approved')}}">@lang('Approuvé')
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.deposit.successful') ? 'active' : '' }}"
                    href="{{route('admin.deposit.successful')}}">@lang('Réussi')
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.deposit.rejected') ? 'active' : '' }}"
                    href="{{route('admin.deposit.rejected')}}">@lang('Rejeté')
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.deposit.initiated') ? 'active' : '' }}"
                    href="{{route('admin.deposit.initiated')}}">@lang('Initié')
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.gateway.automatic.index') ? 'active' : '' }}"
                    href="{{route('admin.gateway.automatic.index')}}">@lang('Passerelles de paiement')
                </a>
            </li>
        </ul>
    </div>
