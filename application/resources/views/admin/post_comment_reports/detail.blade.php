                        ...
                        <div class="card prod-p-card background-pattern">
                            <div class="card-body">
                                <div class="row align-items-center m-b-0">
                                    ...
                                    <p>@lang('Nombre total de likes pour la publication') </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card prod-p-card background-pattern">
                            <div class="card-body">
                                <div class="row align-items-center m-b-0">
                                    ...
                                    <p>@lang('Total des Je n\'aime pas le post') </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card prod-p-card background-pattern">
                            <div class="card-body">
                                <div class="row align-items-center m-b-0">
                                    ...
                                    <p>@lang('Nombre total de commentaires sur le message') </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card prod-p-card background-pattern">
                            <div class="card-body">
                                <div class="row align-items-center m-b-0">
                                    ...
                                    <p>@lang('Total des rapports de poste') </p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row gy-2 pb-2 gx-2">
                    <div class="col-sm-6 col-xl-3">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h5 class="card-title mb-0">@lang('informations de l\'utilisateur')</h5>
                            </div>
                            <div class="card-body">
                                ...
                                <strong class="d-flex">@lang('Nom d\'utilisateur'):<h5>{{ __(@$post->user?->username) }}</h5></strong>
                    ...
                    <div class="col-sm-6 col-xl-9">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h5 class="card-title mb-0">@lang('Informations sur la publication')</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-12 col-md-6 col-12 d-flex">
                                        <strong class="post-content text-xl-start">@lang('Titre'):</strong>
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-md-6 col-12 d-flex text-start">
                                        <strong class="post-content text-xl-start">@lang('Contenue'):</strong>
                ...
                <div class="row pb-2 gx-2">
                    <div class="col-sm-6 col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h5 class="card-title mb-0">@lang('Messages récents')</h5>
                            </div>
                            <div class="card-body">
