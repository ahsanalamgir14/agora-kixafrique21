...
@section('panel')
    ...
    <div class="row gy-4">
        <div class="col-xl-6">
            ...
            <div class="card">
                <div class="card-body">
                    <!-- <h5 class="card-title">@lang('Achats mensuels à crédit') (@lang('Cette année'))</h5> -->
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">@lang('Connexions quotidiennes') (@lang('10 derniers jours'))</h5>
                        ...
                        <div class="card prod-p-card background-pattern">
                            <div class="card-body">
                                <div class="row align-items-center m-b-0">
                                    <div class="col">
                                        <h6 class="m-b-5">@lang('Total déposé')</h6>
                                        <h3 class="m-b-0">
                    ...
                    <a href="{{ route('admin.deposit.list') }}">
                        <div class="card prod-p-card background-pattern-white bg--primary">
                            <div class="card-body">
                                <div class="row align-items-center m-b-0">
                                    <div class="col">
                                        <h6 class="m-b-5 text-white">@lang('Frais déposés')</h6>
                            ...
                            <div class="col-sm-4 col-6 col-xl-6 col-xxl-4">
                                <div class="dashboard-widget">
                                    ...
                                    <div class="dashboard-widget__content">
                                        <a title="@lang('Voir tout')" class="dashboard-widget-link"
                                            href="{{ route('admin.users.all') }}"></a>
                                        <h5>{{ $widget['total_users'] }}</h5>
                                        <span>@lang('Nombre total d\'utilisateurs')</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4 col-6 col-xl-6 col-xxl-4 ">
                                <div class="dashboard-widget">
                                    ...
                                    <div class="dashboard-widget__content">
                                        ...
                                        <span>@lang('Utilisateurs actifs')</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 col-6 col-xl-6 col-xxl-4">
                                <div class="dashboard-widget">
                                    ...
                                    <div class="dashboard-widget__content">
                                        ...
                                        <span>@lang('Dépôts en attente')</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h5 class="card-title">@lang('Billets récents')</h5>
                        <a href="{{ route('admin.ticket.pending') }}" class="float-end"
                            target="_blank">@lang('Voir tout')</a>
                    </div>
