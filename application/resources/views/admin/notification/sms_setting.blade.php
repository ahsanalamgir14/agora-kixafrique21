            ...
            <form action="" method="POST">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label>@lang('Méthode d\'envoi de SMS')</label>
                        <select name="sms_method" class="form-control">
                            ...
                            <option value="custom" @if(@$general->sms_config->name == 'custom') selected
                                @endif>@lang('API personnalisée')</option>
                        </select>
                    </div>
                    <div class="row mt-4 d-none configForm" id="clickatell">
                        <div class="col-md-12">
                            <h6 class="mb-2">@lang('Configuration Clickatell')</h6>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                    ...
                    <div class="row mt-4 d-none configForm" id="nexmo">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="fw-bold">@lang('Secret API') </label>
                    ...
                    <div class="row mt-4 d-none configForm" id="twilio">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="fw-bold">@lang('Numéro de compte du compte') </label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="fw-bold">@lang('Jeton d\'authentification') </label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="fw-bold">@lang('Du numéro') </label>
                    ...
                    <div class="row mt-4 d-none configForm" id="custom">
                        <div class="col-md-12">
                            <h6 class="mb-2">@lang('API personnalisée')</h6>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="card mb-3 dyna-card">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        <button type="button" class="btn btn--primary btn-sm float-right addHeader"><i
                                                class="la la-fw la-plus"></i>@lang('Ajouter') </button>
                                    </div>
                                    <div class="card-body">
                ...
                <div class="card-footer text-end">
                    <button type="submit" class="btn btn-global btn--primary">@lang('Sauvegarder')</button>
                </div>
            </form>
        </div><!-- card end -->
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('Tester la configuration des SMS')</h5>
...
<button type="button" data-bs-target="#testSMSModal" data-bs-toggle="modal" class="btn btn--primary btn-sm">@lang('Tester les SMS')</button>
@endpush
@push('style')
<style>
    .method-select {
