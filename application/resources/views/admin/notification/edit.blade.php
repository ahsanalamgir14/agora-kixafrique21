...
<div class="row">
    <div class="col-md-12">
        ...
        <h6 class="mt-4 mb-2">@lang('Codes courts par défaut')</h6>
        <div class="card overflow-hidden">
            <div class="card-body p-0">
                <div class="table-responsive table-responsive--sm">
                    <table class=" table align-items-center table--light">
...
<form action="{{ route('admin.setting.notification.template.update',$template->id) }}" method="post">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mt-4">
                <div class="card-header bg--primary">
                    <h5 class="card-title text-white">@lang('Modèle d\'e-mail')</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="fw-bold">@lang('Statut')</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg"
                                    placeholder="@lang('Sujet du courriel')" name="subject" value="{{ $template->subj }}"
                                    required />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="email_body" rows="10" class="form-control trumEdit"
                                    placeholder="@lang('Votre message en utilisant des codes courts')">{{ $template->email_body }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="card mt-4">
                <div class="card-header bg--primary">
                    <h5 class="card-title text-white">@lang('Template SMS')</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="sms_body" rows="10" class="form-control"
                                    placeholder="@lang('Votre message en utilisant des codes courts')"
