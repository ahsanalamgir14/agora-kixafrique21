    ...
    <div style="background-image: url('{{ asset('assets/admin/images/login.png') }}')" class="login_area">
        <div class="login">
            <div class="login__header">
                <h2>@lang('Vérification')</h2>
                <p>@lang('entrez le code de vérification S\'il vous plait')</p>
            </div>
            <div class="login__body">
                ...
                <form class="form" action="{{ route('admin.password.verify.code') }}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <label class="form-label" for="input">@lang('Le code de vérification')</label>
                    ...
                    <div class="form-row">
                        <a href="{{ route('admin.password.reset') }}" class="forget-text">@lang('Essayez d\'envoyer à nouveau')</a>
                    </div>
                    <div class="form-row button-login">
                        <button type="submit" class="btn btn-login">@lang('Vérifier') <span class="fas fa-arrow-right"
