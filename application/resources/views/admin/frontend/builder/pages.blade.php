        ...
        <div class="col-lg-6">
            <div class="card b-radius--10 ">
                <div class="card-header text-right">
                    @lang('Pages principales') <button type="button" class="btn btn-sm btn--primary addBtn"><i
                            class="las la-plus"></i>@lang('Ajouter un nouveau')</button>
                </div>
            ...
            <div class="card b-radius--10 ">
                <div class="card-header text-right">
                    @lang('Policy Pages') <a href="{{ route('admin.frontend.sections.element', $key) }}"
                        class="btn btn-sm btn--primary"><i class="las la-plus"></i>@lang('Ajouter un nouveau')</a>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two custom-data-table">
