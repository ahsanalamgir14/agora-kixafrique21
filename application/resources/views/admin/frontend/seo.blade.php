                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                ...
                                                <label for="profilePicUpload1" class="bg--primary">@lang('Télécharger une image')</label>
                                                <small class="mt-2">@lang('Taille recommandée :')
                            ...
                            <div class="col-xl-8 mt-xl-0 mt-4">
                                <div class="form-group ">
                                    ...
                                    <small class="ms-2 mt-2">@lang('Séparez plusieurs mots-clés par')
                                        <code>,</code>(@lang('virgule')) @lang('ou') <code>@lang('entrer')</code>
                                        @lang('clé')</small>
