...
class SiteController extends Controller
{
    ...
    public function contactSubmit(Request $request)
    {
        ...
        if (!verifyCaptcha()) {
            $notify[] = ['error', 'Captcha fourni non valide'];
        ...
        $adminNotification->title = 'Un nouveau ticket d\'assistance a été ouvert ';
