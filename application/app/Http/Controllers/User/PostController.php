...
class PostController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $notify[] = ['success', 'Le post a été mis à jour avec succès'];
    ...
    public function post_bookmark(Request $request)
    {
        ...
        if (!$exist_bookmark) {
            ...
            $data = [
                'status' => "saved",
                'message' => "Le post a été sauvegardé avec succès",
                'id' => $request->post_id,
            ];
        ...
        $data = [
            'status' => "unsaved",
            'message' => "Le post a été altérer avec succès",
            'id' => $request->post_id,
        ];
        return response()->json($data);
    }
    ...
    public function postStatus(Request $request)
    {
        ...
        return response()->json(
            $data = [
                'status' => "success",
                'message' => "Le statut du post a été mis à jour avec succès"
            ],
        );
    }
