                ...
                <form action="" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required"> @lang('Titre du module')</label>
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('Devise')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('Symbole de la monnaie')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('Coût de l\’offre d\’emploi (crédit)')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('Crédit de récompense pour un vote positif')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label> @lang('Prix par crédit')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('ID de l\'application')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('Clé d\'application')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('Secret d\'application')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('Cluster d\'applications')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label> @lang('Site Secondaire Color')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-text p-0 border-0">
                    ...
                    <div class="row mt-4">
                        <div class="form-group col-md-2 col-sm-6 mb-4">
                            <label class="fw-bold">@lang('Enregistrement de l\'utilisateur')</label>
                        ...
                        <div class="form-group col-md-2 col-sm-6 mb-4">
                            <label class="fw-bold">@lang('vérification de l\'E-mail')</label>
                            <label class="switch m-0">
                        ...
                        <div class="form-group col-md-2 col-sm-6 mb-4">
                            <label class="fw-bold">@lang('Notification par Email')</label>
                            <label class="switch m-0">
                        ...
                        <div class="form-group col-md-2 col-sm-6 mb-4">
                            <label class="fw-bold">@lang('Termes et conditions')</label>
                            <label class="switch m-0">
