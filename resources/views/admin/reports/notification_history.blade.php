                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    @else
                                    <span class="fw-bold">@lang('Système')</span>
                                    @endif
                                </td>
                                <td>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 class="text-center mb-3">@lang('à'): <span class="sent_to"></span></h3>
...
<a href="{{ route('admin.users.notification.single',$user->id) }}" class="btn btn--primary btn-sm"><i
        class="las la-paper-plane"></i> @lang('Envoyer une notification')</a>
@else
