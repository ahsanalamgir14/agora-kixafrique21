                    ...
                    <table class="table table--light">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($item->priority == 1)
                                    <span class="badge badge--dark">@lang('Faible')</span>
                                    @elseif($item->priority == 2)
                                    <span class="badge  badge--warning">@lang('Moyen')</span>
                                    @elseif($item->priority == 3)
                                    <span class="badge badge--danger">@lang('Haut')</span>
                                    @endif
                                </td>
                                <td>
