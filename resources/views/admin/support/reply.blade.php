...
<div class="row gy-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4  col-md-6 text-sm-end mt-sm-0 mt-3">
                            ...
                            <button class="btn btn--danger btn-sm" type="button" data-bs-toggle="modal"
                                data-bs-target="#DelModal">@lang('Fermer le billet')
                            </button>
                            @endif
                        </div>
                    </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title border-bottom pb-2 w-100">@lang('Réponses aux tickets')</h4>
                    ...
                    <div class="col">
                        ...
                        <div class="my-3">
                            ...
                            <a href="{{route('admin.ticket.download',encrypt($image->id))}}" class="me-2"><i
                                    class="fa fa-file"></i> @lang('Pièce jointe') {{++$k}}</a>
                            @endforeach
                        </div>
                        @endif
                ...
                <div class="row admin-reply">
                    <div class="col">
                        ...
                        @endif
                        <button class="btn btn-danger btn-sm my-3 confirmationBtn float-end"
                            data-question="@lang('Êtes-vous sûr de supprimer ce message ?')"
                            data-action="{{ route('admin.ticket.delete',$message->id)}}"><i
                                class="la la-trash"></i></button>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> @lang('Fermer le ticket d\'assistance !')</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <i class="las la-times"></i>
                </button>
            </div>
            <div class="modal-body">
                <p>@lang('Souhaitez-vous clôturer ce ticket de support?')</p>
            </div>
...
<a href="{{ route('admin.ticket') }}" class="btn btn-sm btn--primary">@lang('Retour')
</a>
@endpush
            ...
            $("#fileUploadsContainer").append(`
                    <div class="row">
                        <div class="col-9 mb-3">
                            <div class="file-upload-wrapper" data-text="@lang('Sélectionnez votre fichier !')"><input type="file" name="attachments[]" id="inputAttachments" class="file-upload-field"/></div>
                        </div>
                        <div class="col-3">
