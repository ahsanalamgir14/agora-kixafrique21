        ...
        <div class="card">
            <form action="" class="notify-form">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="fw-bold">@lang('Sujet') </label>
                                <input type="text" class="form-control" placeholder="@lang('Email sujet')"
                ...
                <div class="card-footer text-end">
                    <button type="submit" class="btn btn-global btn--primary me-2">@lang('Envoyer')</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('Envoi de notifications')</h5>
            </div>
            <div class="modal-body">
                <h4 class="text--danger text-center">@lang('Ne fermez pas et n\'actualisez pas la fenêtre avant d\'avoir terminé')</h4>
                ...
                <div class="mt-3">
                    ...
                    <p>@lang('Email envoyé') <span class="sent">0</span> @lang('utilisateurs hors de') {{ $users }} @lang('utilisateurs')
                    </p>
                </div>
            </div>
        </div>
...
<span class="text--primary">@lang('La notification sera envoyée via ') @if($general->en) <span
        ...
        function postMail(form, skip) {
            ...
            if (rest == 0) {
                setTimeout(() => {
                    ...
                    notify('success', 'Courrier envoyé à tous les utilisateurs avec succès')
                }, 3000);
                return false;
            }
            setTimeout(() => {
