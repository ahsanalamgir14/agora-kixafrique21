    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="createModalLabel"> @lang('Ajouter une nouvelle langue')</h4>
            ...
            <form class="form-horizontal" method="post" action="{{ route('admin.language.manage.store')}}">
                ...
                <div class="modal-body">
                    <div class="row form-group">
                        <label>@lang('Nom de la langue')</label>
                        <div class="col-sm-12">
                    ...
                    <div class="row form-group">
                        <label>@lang('Code de langue')</label>
                        <div class="col-sm-12">
                    ...
                    <div class="row form-group">
                        <label>@lang('Langage par défaut')</label>
                        <div class="col-sm-12">
                            <select name="is_default" id="setDefault" class="form-control">
                                <option value="1">Default</option>
                                <option value="0">Pas par défaut</option>
                            </select>
                        </div>
                    </div>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="editModalLabel">@lang('Modifier la langue')</h4>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><i
                        class="las la-times"></i></button>
            </div>
            <form method="post">
