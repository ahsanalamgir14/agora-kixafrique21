    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('Poste')</h5>
            ...
            <form method="POST" action="{{ route('user.post.store') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <label class="form--label" for="create-recipient-name">@lang('Titre')</label>
                    </div>
                    ...
                    <p class="mb-2">@lang('Extensions de fichiers autorisées'): .@lang('jpg'), .@lang('jpeg'), .@lang('png') @lang('(max:'); <strong>@lang('2MB)')</strong></p>
                    <div class="form-group mb-4">
                    ...
                    <div class="form-group mb-4">
                        <textarea class="form--control trumEdit" placeholder="Ecrivez votre sujet" name="content"></textarea>
                    </div>

                    <div class="form-group text-end">
                        <button type="submit" class="btn btn-primary text-end">@lang('Créer')</button>
                    </div>
                </div>
            </form>
        </div>
...
<div class="modal fade" id="jobPostExampleModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('Poste de travail')</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="POST" action="{{ route('user.post.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group mb-4">
                        <input type="text" class="form-control form--control" id="create-recipient-title"
                            name="title" placeholder="">
                        <label class="form--label" for="create-recipient-title">@lang('Titre')</label>
                    </div>

                    <div class="form-group mb-4">
                        <input class="form-control form--control" type="date" name="deadline">
                        <label class="form--label">@lang('Date limite')</label>
                    </div>

                    <div class="form-group mb-4">
                        <input class="form-control form--control" type="number" placeholder="" name="vacancy">
                        <label class="form--label">@lang('Poste vacant')</label>
                    </div>

                    <div class="form-group mb-4">
                        <div class="form-group">
                            <input class="form--control" placeholder="" type="number" name="salary">
                            <label class="form--label">@lang('Échelle salariale')</label>
                        </div>
                    </div>
