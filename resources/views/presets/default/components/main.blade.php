            ...
            <div class="card-auth-meta">
                <div class="auth-info">
                    <a href="{{ route('user.profile.details', $post->user?->id) }}">
                        ...
                        <p class="post-by">@lang('Posté par')
                    ...
                    @if(@$post->job)<i class="fa-solid fa-circle"></i><p class="time-status">@lang('Date limite'): {{ showDateTime(@$post->deadline, 'd M, Y')}}</p>@endif
