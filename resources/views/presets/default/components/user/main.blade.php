        ...
        <a class="d-block" href="buy-credit.html">
            <div class="dashboard-card">
                ...
                <div class="dashboard-card__content">
                    <h5 class="dashboard-card__title">@lang('Crédit total')</h5>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <a class="d-block" href="#">
            <div class="dashboard-card">
                ...
                <div class="dashboard-card__content">
                    <h5 class="dashboard-card__title">@lang('Poste total')</h5>
                    <h5 class="dashboard-card__amount">500</h5>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <a class="d-block" href="#">
            <div class="dashboard-card">
                ...
                <div class="dashboard-card__content">
                    <h5 class="dashboard-card__title">@lang('Message approuvé')</h5>
                    <h5 class="dashboard-card__amount">500</h5>
                </div>
            </div>
        </a>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <a class="d-block" href="#">
            <div class="dashboard-card">
                ...
                <div class="dashboard-card__content">
                    <h5 class="dashboard-card__title">@lang('Message en attente')</h5>
                    <h5 class="dashboard-card__amount">500</h5>
                </div>
            </div>
        </a>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <a class="d-block" href="#">
            <div class="dashboard-card">
                ...
                <div class="dashboard-card__content">
                    <h5 class="dashboard-card__title">@lang('Rejeter le message')</h5>
    ...
    <div class="col-xl-4 col-lg-6 col-sm-6">
        <a class="d-block" href="#">
            <div class="dashboard-card">
                ...
                <div class="dashboard-card__content">
                    <h5 class="dashboard-card__title">@lang('Rapport')</h5>
                    <h5 class="dashboard-card__amount">500</h5>
                </div>
            </div>
        </a>
