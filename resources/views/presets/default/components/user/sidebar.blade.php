            ...
            <div class="nav-menu">
                <div class="navmenu-item-wraper">
                    <a href="{{ route('user.home') }}" class="menu-item">
                        ...
                        <h6 class="text {{ menuActive('user.home') }}">@lang('Tableau de bord')</h6>
                    </a>
