                                ...
                                <div class="row gy-4 justify-content-center">
                                            ...
                                            <div class="dashboard_profile__details">
                                                <div class="dashboard_profile_wrap">
                                                    ...
                                                    <div class="profile-details">
                                                        <ul>
                                                            <li>
                                                                <p><span>@lang('Nom d\'utilisateur:')</span>
                                    ...
                                    <div class="col-lg-10 justify-content-center">
                                        <div class="user-profile payment-info">
                                            <div class="row gy-3">
                                                <div class="col-lg-12">
                                                    <h4 class="mb-1">@lang('Informations personnelles')</h4>
                                                </div>
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form--control" id="firstname"
                                                            ...
                                                            required>
                                                        <label for="firstname"
                                                            class="form--label required">@lang('Prénom')</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form--control" id="lastname"
                                                            ...
                                                            required>
                                                        <label for="lastname"
                                                            class="form--label required">@lang('Nom de famille')</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-group">
                                                        <input type="text" class="form--control" id="email"
                                                            ...
                                                            readonly>
                                                        <label for="email" class="form--label">@lang('Votre e-mail ')</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="zip-code" class="form--label">@lang('Code postal')</label>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="number"
                                                                ...
                                                                aria-label="Montant en dollars (avec point et deux décimales)" required>
                                                        </div>
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="state" class="form--label">@lang('État')</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 mb-3">
                                                        <div class="form-group skill-input">
                                                            <label class="mb-3">@lang('Compétences')</label>
                                                            <small class="ms-2 mt-2">@lang('Séparez plusieurs mots-clés par')
                                                                <code>,</code>(@lang('virgule')) @lang('ou')
                                                                <code>@lang('entrer')</code>
                                                                @lang('clé')</small>
                                                            <select name="skills[]"
                                                                class="form-control form--control select2-auto-tokenize"
                                                                multiple="multiple" require>
                                                                @if (@$skills)
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="email"
                                                            class="form--label">@lang('Adresse')</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <button type="submit"
                                                        class="btn btn--base w-100">@lang('Sauvegarder le profil')</button>
                                                </div>
                                            </div>
