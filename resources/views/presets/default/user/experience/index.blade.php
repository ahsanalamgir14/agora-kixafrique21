                                        ...
                                        <form action="{{ route('user.experience.store') }}" method="post">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <label class="form--label"
                                                    for="create-recipient-name">@lang('Titre')</label>
                                            </div>
                                            <div class="form-group mb-4">
                                                <input type="text" class="form-control form--control"
                                                    id="create-company-name" name="company_name" placeholder="">
                                                <label class="form--label"
                                                    for="create-company-name">@lang('Nom de l\'entreprise')</label>
                                            </div>

                                            <div class="form--check form-group mb-4">
                                                <input class="form-check-input" type="checkbox" value="on"
                                                    id="create-flexCheckDefault" name="curr_working" style="color: #fff;"
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <label for="create-start-date" class="form--label">@lang('Date de début')</label>
                                            </div>

                                            <div class="form-group mb-4">
                                                <input type="date" class="form-control form--control"
                                                    id="create-end-date" name="end_date" readonly>
                                                <label for="create-end-date" class="form--label">@lang('Date de fin')</label>
                                            </div>
                                            <div class="form-group mb-4">
                                                <input type="text" class="form-control form--control"
                                                    id="create-location" name="location" placeholder="">
                                                <label for="create-location" class="form--label">@lang('Localisation')</label>
                                            </div>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <label for="create-message-text"
                                                    class="form--label">@lang('Responsibilité')</label>
                                            </div>

                                            <div class="form-group text-end">
                                                <button type="submit"
                                                    class="btn btn-primary text-end" style="color: #ffffff;">@lang('Sauvegarder')</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
