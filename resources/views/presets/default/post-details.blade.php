                                        ...
                                        <div class="card--body">
                                            <div class="card-auth-meta">
                                                <div class="auth-info">
                                                    <a href="{{ route('user.profile.details', @$post->user?->id) }}">
                                                        ...
                                                        <p class="post-by">
                                                            @lang('posté par')<span> {{ __(@$post->user?->fullname) }}</span>
                                                        </p>
                                                    </a>
                                                    ...
                                                    @if (@$post->created_at != @$post->updated_at && @$post->created_at < @$post->updated_at)
                                                        <p class="time-status">@lang('Mis à jour à')
                                            ...
                                            <div class="card-content">
                                                ...
                                                @if ($post->job == 1)
                                                    ...
                                                    <div class="mb-3">
                                                        <p>@lang('Poste vacant:') {{ $post->vacancy }}</p>
                                                    </div>
                                                @endif
                                                ...
                                                <ul class="footer-item-list">
                                                    ...
                                                    <li>
                                                        <div class="footer-item">
                                                            ...
                                                            <p>{{ number_format_short(@$post->views) }} @lang('Vues')
                                                            </p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <form>
                                                            <div class="form-group">
                                                                ...
                                                                <label class="form--label">
                                                                    @if ($post->text === 1)
                                                                        @lang('Ecrivez votre réponse')
                                                                    @else
                                                                        @lang('Écrivez vos commentaires')
                                                                    @endif
                                                                </label>
                                                            </div>
                                                        </form>
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <div class="form-group mb-3">
                                    <label class="form-label mb-3 required" for="amount">@lang('Salaire attendu:')</label>
                                ...
                                <label class="col-form-label">@lang('CV:')</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <label for="report-modal" class="col-form-label">@lang('Raison:')</label>
                            <textarea class="form-control post-reason" name="reason" id="report-modal"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success post-details-report-modal">@lang('Envoyer')</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal fade comment_report_modal" id="exampleModal1" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form id="comment_report_form">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">@lang('Rapport')</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <label for="message-text" class="col-form-label">@lang('Raison'):</label>
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.post_vote', function() {
                    ...
                    if (auth) {
                        ...
                        Toast.fire({
                            icon: 'error',
                            title: 'Veuillez vous connecter à votre compte'
                        })
                    }
                })
